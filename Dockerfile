# ══════════════════════════════════════════════════════════
#  PetraPOS v7.3 — Dockerfile para VPS
...
# Metadatos
LABEL maintainer="PetraPOS Honduras"
LABEL version="7.3.0"
LABEL description="Sistema de Punto de Venta — PetraPOS"
...
RUN mkdir -p /datos/petrapos && chown node:node /datos/petrapos

# Variables de entorno por defecto (sobreescribir en docker-compose o runtime)
ENV NODE_ENV=production
ENV PORT=3000
ENV DATA_DIR=/datos/petrapos
